...
namespace irr
{
    ...
    namespace scene
    {
        ...
        //! A scene node for displaying terrain using the geo mip map.png algorithm.
         ...
         *
         * The Patch Size of the terrain must always be a size of ( 2^N+1, a.e. 8+1(9), 16+1(17), etc. ).
        ...
        class ITerrainSceneNode : public ISceneNode
        {
            public:
            //! Constructor
            ITerrainSceneNode(ISceneNode *parent, ISceneManager *mgr, s32 id, const core::vector3df &position = core::vector3df(0.0f, 0.0f, 0.0f),
            ...
            \param vertexColor Color of all vertices.
            \param smoothFactor Number of smoothing passes. */
            virtual bool loadHeightMapRAW(io::IReadFile *file, s32 bitsPerPixel = 16, bool signedData = false, bool floatVals = false, s32 width = 0,
