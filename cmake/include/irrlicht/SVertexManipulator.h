...
namespace irr
{
    namespace scene
    {
        ...
        */
        ...
        {
            public:
            SVertexColorThresholdManipulator(u8 threshold, video::SColor low, video::SColor high) : Threshold(threshold), Low(low), High(high)
            {
            }
        ...
        {
            public:
            SVertexColorInterpolateLinearManipulator(video::SColor color, f32 factor) : Color(color), Factor(factor)
            {
            }
        ...
        {
            public:
            SVertexColorInterpolateQuadraticManipulator(video::SColor color1, video::SColor color2, f32 factor) : Color1(color1), Color2(color2),
                Factor(factor)
            {
            }
