...
namespace irr
{
    namespace video
    {
        ...
        {
            return (((-((s32)color & 0x00008000) >> (s32)31) & 0xFF000000) | ((color & 0x00007C00) << 9) | ((color & 0x00007000) << 4) |
                ((color & 0x000003E0) << 6) | ((color & 0x00000380) << 1) | ((color & 0x0000001F) << 3) | ((color & 0x0000001C) >> 2));
        }
        ...
        */
        class SColor
        {
            ...
            {
                return SColor(core::min_(getAlpha() + other.getAlpha(), 255u), core::min_(getRed() + other.getRed(), 255u),
                    core::min_(getGreen() + other.getGreen(), 255u), core::min_(getBlue() + other.getBlue(), 255u));
            }
            ...
            SColor getInterpolated(const SColor &other, f32 d) const
            {
                ...
                return SColor((u32)core::round32(other.getAlpha() * inv + getAlpha() * d), (u32)core::round32(other.getRed() * inv + getRed() * d),
                    (u32)core::round32(other.getGreen() * inv + getGreen() * d), (u32)core::round32(other.getBlue() * inv + getBlue() * d));
            }
        ...
        */
        class SColorf
        {
            ...
            {
                return SColor((u32)core::round32(a * 255.0f), (u32)core::round32(r * 255.0f), (u32)core::round32(g * 255.0f),
                    (u32)core::round32(b * 255.0f));
            }
            ...
            SColorf getInterpolated(const SColorf &other, f32 d) const
            {
                d = core::clamp(d, 0.f, 1.f);
                const f32 inv = 1.0f - d;
                return SColorf(other.r * inv + r * d, other.g * inv + g * d, other.b * inv + b * d, other.a * inv + a * d);
            }
            ...
            inline SColorf getInterpolated_quadratic(const SColorf &c1, const SColorf &c2, f32 d) const
            {
                ...
                return SColorf(r * mul0 + c1.r * mul1 + c2.r * mul2, g * mul0 + c1.g * mul1 + c2.g * mul2, b * mul0 + c1.b * mul1 + c2.b * mul2,
        ...
        */
        ...
        {
            public:
            SColorHSL(f32 h = 0.f, f32 s = 0.f, f32 l = 0.f) : Hue(h), Saturation(s), Luminance(l)
            {
            }
        ...
        inline void SColorHSL::toRGB(SColorf &color) const
        {
            ...
            color.set(toRGB1(rm1, rm2, h + 1.f / 3.f), toRGB1(rm1, rm2, h), toRGB1(rm1, rm2, h - 1.f / 3.f));
        }
