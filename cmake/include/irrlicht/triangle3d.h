    ...
    namespace core
    {
        ...
        class triangle3d
        {
            ...
            bool isPointInside(const vector3d <T> &p) const
            {
                ...
                return (isOnSameSide(pf64, af64, bf64, cf64) && isOnSameSide(pf64, bf64, af64, cf64) && isOnSameSide(pf64, cf64, af64, bf64));
            }
            ...
            bool isOnSameSide(const vector3d <f64> &p1, const vector3d <f64> &p2, const vector3d <f64> &a, const vector3d <f64> &b) const
            {
                ...
                if (res < 0)
                {
                    ...
                    if (core::iszero(cp1.X, (f64)ROUNDING_ERROR_f32) && core::iszero(cp1.Y, (f64)ROUNDING_ERROR_f32) &&
