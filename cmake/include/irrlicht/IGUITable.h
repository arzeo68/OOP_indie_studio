...
namespace irr
{
    namespace gui
    {
        ...
        const c8 *const GUIColumnOrderingNames[] = {"none", "custom", "ascend", "descend", "ascend_descend", 0,};
        ...
        const c8 *const GUIOrderingModeNames[] = {"none", "ascending", "descending", 0};
        ...
        */
        class IGUITable : public IGUIElement
        {
            public:
            //! constructor
            IGUITable(IGUIEnvironment *environment, IGUIElement *parent, s32 id, core::rect <s32> rectangle) : IGUIElement(EGUIET_TABLE, environment,
                parent, id, rectangle)
            {
            }
