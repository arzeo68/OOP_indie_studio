...
namespace irr
{
    namespace scene
    {
        ...
        const c8 *const BoneAnimationModeNames[] = {"automatic", "animated", "unanimated", 0,};
        ...
        class IBoneSceneNode : public ISceneNode
        {
            ...
            IBoneSceneNode(ISceneNode *parent, ISceneManager *mgr, s32 id = -1) : ISceneNode(parent, mgr, id), positionHint(-1), scaleHint(-1),
                rotationHint(-1)
            {
            }
            ...
            _IRR_DEPRECATED_ virtual const c8 *getBoneName() const
            {
                return getName();
            }
