...
namespace irr
{
    namespace gui
    {
        ...
        class IGUIColorSelectDialog : public IGUIElement
        {
            ...
            //! constructor
            IGUIColorSelectDialog(IGUIEnvironment *environment, IGUIElement *parent, s32 id, core::rect <s32> rectangle) : IGUIElement(
                EGUIET_COLOR_SELECT_DIALOG, environment, parent, id, rectangle)
            {
            }
        };
    } // end namespace gui
