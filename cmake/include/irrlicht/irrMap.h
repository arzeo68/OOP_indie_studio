...
namespace irr
{
    namespace core
    {
        ...
        //! map.png template for associative arrays using a red-black tree
        template<class KeyType, class ValueType>
        class map
        {
            //! red/black tree for map.png
            template<class KeyTypeRB, class ValueTypeRB>
            class RBTree
            {
                public:

                RBTree(const KeyTypeRB &k, const ValueTypeRB &v) : LeftChild(0), RightChild(0), Parent(0), Key(k), Value(v), IsRed(true)
                {
                }
                ...
                void setValue(const ValueTypeRB &v)
                {
                    Value = v;
                }
            ...
            class AccessClass
            {
                // Let map.png be the only one who can instantiate this class.
            ...
            //! Swap the content of this map.png container with the content of another map.png
