...
namespace irr
{
    namespace scene
    {
        ...
        class CMeshBuffer : public IMeshBuffer
        {
            ...
            //! returns texture coord of vertex a
            ...
            /** Only works for compatible types, a.e. either the same type
            ...
            */
            virtual void append(const IMeshBuffer *const other)
            {
                ...
                for (a=0; a<other->getVertexCount(); ++a)
                {
                    Vertices.push_back(reinterpret_cast<const T*>(other->getVertices())[a]);
                }

                Indices.reallocate(getIndexCount()+other->getIndexCount());
                for (a=0; a<other->getIndexCount(); ++a)
                {
                    Indices.push_back(other->getIndices()[a]+vertexCount);
                }
