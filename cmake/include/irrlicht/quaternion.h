    ...
    namespace core
    {
        ...
        class quaternion
        {
            ...
            /*!
                ...
                shortcut for
                core::quaternion q;
                q.rotationFromTo ( vin[a].Normal, forward );
        ...
        */
        ...
        /*!
            ...
            lookat *= m2;
        */
        inline void quaternion::getMatrixCenter(matrix4 &dest, const core::vector3df &center, const core::vector3df &translation) const
        {
            dest[0] = 1.0f - 2.0f * Y * Y - 2.0f * Z * Z;
            dest[1] = 2.0f * X * Y + 2.0f * Z * W;
            dest[2] = 2.0f * X * Z - 2.0f * Y * W;
