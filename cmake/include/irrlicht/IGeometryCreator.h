    ...
    namespace scene
    {
        ...
        class IGeometryCreator : public IReferenceCounted
        {
            ...
            */
            ...
            \return Generated mesh.
            */
            virtual IMesh *createHillPlaneMesh(const core::dimension2d <f32> &tileSize, const core::dimension2d <u32> &tileCount,
            ...
            \return Generated mesh.
            */
            IMesh *createPlaneMesh(const core::dimension2d <f32> &tileSize, const core::dimension2d <u32> &tileCount = core::dimension2du(1, 1),
                video::SMaterial *material = 0, const core::dimension2df &textureRepeatCount = core::dimension2df(1.f, 1.f)) const
            {
            ...
            \param stretchSize The size that each pixel will produce, a.e. a
            512x512 heightmap
            ...
            \return Generated mesh.
            */
            virtual IMesh *createTerrainMesh(video::IImage *texture, video::IImage *heightmap, const core::dimension2d <f32> &stretchSize,
                f32 maxHeight, video::IVideoDriver *driver, const core::dimension2d <u32> &defaultVertexBlockSize, bool debugBorders = false
            ) const = 0;
            ...
            \return Generated mesh.
            */
            virtual IMesh *createArrowMesh(const u32 tesselationCylinder = 4, const u32 tesselationCone = 8, const f32 height = 1.f,
                const f32 cylinderHeight = 0.6f, const f32 widthCylinder = 0.05f, const f32 widthCone = 0.3f,
                const video::SColor colorCylinder = 0xFFFFFFFF, const video::SColor colorCone = 0xFFFFFFFF
            ) const = 0;
            ...
            */
            ...
            \return Generated mesh.
            */
            virtual IMesh *createCylinderMesh(f32 radius, f32 length, u32 tesselation, const video::SColor &color = video::SColor(0xffffffff),
            ...
            \return Generated mesh.
            */
            virtual IMesh *createConeMesh(f32 radius, f32 length, u32 tesselation, const video::SColor &colorTop = video::SColor(0xffffffff),
                const video::SColor &colorBottom = video::SColor(0xffffffff), f32 oblique = 0.f
            ) const = 0;
            ...
            \return Generated mesh.
            */
            virtual IMesh *createVolumeLightMesh(const u32 subdivideU = 32, const u32 subdivideV = 32, const video::SColor footColor = 0xffffffff,
                const video::SColor tailColor = 0xffffffff, const f32 lpDistance = 8.f,
