...
namespace irr
{
    namespace scene
    {
        ...
        class IParticleFadeOutAffector : public IParticleAffector
        {
            ...
            //! Sets the targetColor, a.e. the color the particles will interpolate to over time.
            ...
            //! Gets the targetColor, a.e. the color the particles will interpolate to over time.
