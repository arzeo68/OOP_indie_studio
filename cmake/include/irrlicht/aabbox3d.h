    ...
    namespace core
    {
        ...
        */
        ...
        class aabbox3d
        {
            ...
            {
                f32 inv = 1.0f - d;
                return aabbox3d<T>((other.MinEdge * inv) + (MinEdge * d), (other.MaxEdge * inv) + (MaxEdge * d));
            }
            ...
            {
                return intersectsWithLine(line.getMiddle(), line.getVector().normalize(), (T)(line.getLength() * 0.5));
            }
            ...
            bool intersectsWithLine(const vector3d<T> &linemiddle, const vector3d<T> &linevect, T halflength) const
            {
                ...
                return !(fabs(t.X * linevect.Y - t.Y * linevect.X) > r);
            }
