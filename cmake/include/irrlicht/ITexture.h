...
namespace irr
{
    namespace video
    {
        ...
        enum E_TEXTURE_CREATION_FLAG
        {
            ...
            /** Automatically creates mip map.png levels for the textures. */
        ...
        */
        class ITexture : public virtual IReferenceCounted
        {
            ...
            unlocked.
            The size of the a-th mipmap level is defined as max(getSize().Width>>a,1)
            and max(getSize().Height>>a,1)
            ...
            //! Regenerates the mip map.png levels of the texture.
