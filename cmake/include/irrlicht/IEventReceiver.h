...
namespace irr
{
    ...
    struct SEvent
    {
        ...
        struct SMouseInput
        {
            ...
            {
                return 0 != (ButtonStates & EMBSM_LEFT);
            }
            ...
            {
                return 0 != (ButtonStates & EMBSM_MIDDLE);
            }
        ...
        struct SJoystickEvent
        {
            ...
            /** This is an internal Irrlicht index; it does not map.png directly
    ...
    struct SJoystickInfo
    {
        ...
        //! The number of axes that the joystick has, a.e. X, Y, Z, R, U, V.
