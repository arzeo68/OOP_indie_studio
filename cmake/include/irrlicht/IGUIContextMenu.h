    ...
    namespace gui
    {
        ...
        */
        class IGUIContextMenu : public IGUIElement
        {
            ...
            //! constructor
            IGUIContextMenu(IGUIEnvironment *environment, IGUIElement *parent, s32 id, core::rect <s32> rectangle) : IGUIElement(EGUIET_CONTEXT_MENU,
            ...
            virtual u32 addItem(const wchar_t *text, s32 commandId = -1, bool enabled = true, bool hasSubMenu = false, bool checked = false,
            ...
            \param autoChecking: Specifies if the item should be checked by clicking
            \return Returns the index of the new item */
            virtual u32 insertItem(u32 idx, const wchar_t *text, s32 commandId = -1, bool enabled = true, bool hasSubMenu = false,
