    ...
    namespace core
    {
        ...
        */
        ...
        class array
        {
            ...
            array(u32 start_count) : data(0), allocated(0), used(0), strategy(ALLOC_STRATEGY_DOUBLE), free_when_destroyed(true), is_sorted(true)
            {
            ...
            */
            ...
            void insert(const T &element, u32 index = 0)
            {
                ...
                if (used + 1 > allocated)
                {
                    ...
                    for (u32 i = used; i > index; --i)
                    {
                        ...
                        allocator.construct(&data[i], data[i - 1]); // data[a] = data[a-1];
                    }
            ...
            const array<T, TAlloc> &operator=(const array<T, TAlloc> &other)
            {
                ...
                for (u32 i = 0; i < other.used; ++i)
                    allocator.construct(&data[i], other.data[i]); // data[a] = other.data[a];
            ...
            void erase(u32 index)
            {
                ...
                for (u32 i = index + 1; i < used; ++i)
                {
                    ...
                    allocator.construct(&data[i - 1], data[i]); // data[a-1] = data[a];
                }
            ...
            void erase(u32 index, s32 count)
            {
                ...
                for (i = index + count; i < used; ++i)
                {
                    ...
                    allocator.construct(&data[i - count], data[i]); // data[a-count] = data[a];
