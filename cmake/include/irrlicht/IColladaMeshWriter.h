    ...
    namespace scene
    {
        ...
        */
        class IColladaMeshWriterNames : public virtual IReferenceCounted
        {
            ...
            */
            virtual irr::core::stringw nameForMaterial(const video::SMaterial &material, int materialId, const scene::IMesh *mesh,
        ...
        class IColladaMeshWriter : public IMeshWriter
        {
            ...
            IColladaMeshWriter() : Properties(0), DefaultProperties(0), NameGenerator(0), DefaultNameGenerator(0), WriteTextures(true),
                WriteDefaultScene(true), ExportSMaterialOnce(true), AmbientLight(0.f, 0.f, 0.f, 1.f), GeometryWriting(ECGI_PER_MESH)
            {
            }
            ...
            */
            ...
            virtual irr::core::stringw toNCName(const irr::core::stringw &oldString,
                const irr::core::stringw &prefix = irr::core::stringw(L"_NC_")) const = 0;
